...
function (e) {
        ...
        function i(i, p) {
                ...
                function e() {
                        ...
                        Y || (e = N.find(".timepicker [data-action=togglePeriod]"), t = E.clone().add(12 <= E.hours() ? -12 : 12, "h"), e.text(E.format("A")), m(t, "h") ? e.removeClass("disabled") : e.addClass("disabled")),
                        ...
                        function () {
                                var e = N.find(".timepicker-hours table"),
                                        ...
                                        a = [],
                                        n = $("<tr>");
                                for (11 < H.hour() && !Y && t.hour(12); t.isSame(H, "d") && (Y || H.hour() < 12 && t.hour() < 12 || 11 < H.hour());) t.hour() % 4 == 0 && (n = $("<tr>"), a.push(n)),
                        ...
                        function () {
                                for (var e = N.find(".timepicker-minutes table"), t = H.clone().startOf("h"), a = [], n = $("<tr>"), r = 1 === p.stepping ? 5 : p.stepping; H.isSame(t, "h");) t.minute() % (4 * r) == 0 && (n = $("<tr>"), a.push(n)),
                        ...
                        function () {
                                for (var e = N.find(".timepicker-seconds table"), t = H.clone().startOf("m"), a = [], n = $("<tr>"); H.isSame(t, "m");) t.second() % 20 == 0 && (n = $("<tr>"), a.push(n)),
                ...
                var E, H, I, Y, q, B, j, A, F, L = {},
                        ...
                        X = {
                                ...
                                selectMonth: function (e) {
                                        ...
                                        H.month(t),
                                        j === V ? (g(E.clone().year(H.year()).month(H.month())), p.inline || b()) : (o(-1), s()),
                                        r("M")
                                },
                                selectYear: function (e) {
                                        var t = parseInt($(e.target).text(), 10) || 0;
                                        H.year(t),
                                        j === V ? (g(E.clone().year(H.year())), p.inline || b()) : (o(-1), s()),
                                        r("YYYY")
                                },
                ...
                if (L.destroy = function () {
                        ...
                        if ("boolean" == typeof e && !e) return p.daysOfWeekDisabled = !1,
                        y(),
                        L;
                        ...
                        if ("boolean" == typeof e && !1 === e) return p.maxDate = !1,
                        y(),
                        L;
                        ...
                        if ("boolean" == typeof e && !1 === e) return p.minDate = !1,
                        y(),
                        L;
                        "string" == typeof e && ("now" !== e && "moment" !== e || (e = c()));
                        var t = v(e);
                        ...
                        return p.collapse === e || (p.collapse = e, N && (b(), D())),
                        L
                }, L.icons = function (e) {
                        ...
                        if (!e) return p.disabledTimeIntervals = !1,
                        y(),
                        L;
                ...
                return E = c(),
                H = E.clone(),
                $.extend(!0, p, (F = {}, (A = i.is("input") || p.inline ? i.data() : i.find("input").data()).dateOptions && A.dateOptions instanceof Object && (F = $.extend(!0, F, A.dateOptions)), $.each(p, function (e) {
